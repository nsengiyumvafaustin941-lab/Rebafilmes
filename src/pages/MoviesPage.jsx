...
const MOVIE_COLLECTIONS = [
  {
    ...
    queries: ['Extraction', 'John Wick', 'Top Gun Maverick', 'Fast X', 'Mad Max Fury Road', 'The Gray Man', 'Nobody', 'Bullet Train'],
  },
  {
    title: 'Mind-Bending Sci-Fi',
    queries: ['Inception', 'Interstellar', 'Dune Part Two', 'The Matrix', 'Arrival', 'Ex Machina', 'Annihilation', 'Tenet'],
  },
  {
    title: 'Date Night & Rom-Coms',
    queries: ['Anyone But You', 'The Idea of You', 'Crazy Rich Asians', 'To All the Boys', 'Set It Up', 'Always Be My Maybe', 'La La Land', 'About Time'],
  },
  {
    title: 'Critically Acclaimed',
    queries: ['Oppenheimer', 'Parasite', 'Everything Everywhere All At Once', 'The Shawshank Redemption', 'Schindlers List', 'Whiplash', 'Moonlight', 'The Godfather'],
  },
];
